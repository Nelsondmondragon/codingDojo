public class AlfredTest {
        ...
        public static void main(String[] args) {
                ...
                System.out.println(alfredBot.guestGreeting("Nelson", alfredBot.dayPeriod()));

                String pruebaEnojado = " este texto es una prueba para el rObot";
                String pruebaFeliz = " este texto es la muestra del alfred feliz";
                System.out.println(alfredBot.speak(pruebaEnojado));
                System.out.println(alfredBot.speak(pruebaFeliz));
